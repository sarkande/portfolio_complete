package com.visiplus.portfolio.security;
...
public class SecurityConfiguration {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:4200","http://localhost:3000", "http://allanperez.fr:3000", "https://allanperez.fr", "https://portfolio-preprod.heimdall" )); // ton front Angular
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/auth/login", "/h2-console/**", "/projects", "/projects/*", "/projects/last_projects", "/skills", "/skills/*", "/skills/*/projects", "/articles", "/articles/*").permitAll()
